...
//                      <div><div className="text-sm font-medium text-slate-500">Email</div><a href="mailto:jeffreythomas10566x@gmail.com" className="text-lg font-semibold text-slate-900 cursor-none">jeffreythomas10566x@gmail.com</a>
//                      </div>
...
//       type: "Web App",
//       image: liveCodingImg,
//       live: "https://codemate-0q8m.onrender.com",
//     },
//     {
//       title: "Realtime Chat App",
//       date: "Mar 2025",
...
//       type: "Web App",
//       image: chatAppImg,
//       live: "https://chatapp-co8p4.sevalla.app/",
//     },    
//     {
//       title: "Netflix Clone",
//       date: "Feb 2025",
...
//     const sections = ['home', 'about', 'activity', 'projects', 'contact'];
...
//       {/* --- ABOUT SECTION --- */}
//       <section id="about" ref={aboutRef} className="py-24 px-6 relative z-10 max-w-7xl mx-auto overflow-visible">
        
//         {/* Alignment Fix: items-start to align top edges */}
//         <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
           
//            {/* Left Column: Vertical Stack */}
//            <div className={`flex flex-col relative h-full scroll-fade-in ${aboutVisible ? 'visible' : ''}`}>
//               {/* Header */}
//               <div className="mb-10">
//                  <div className="text-sm font-bold tracking-widest text-slate-500 uppercase mb-4">About Me</div>
//                  <h2 className="text-4xl md:text-5xl font-bold text-slate-900 leading-tight">Digital Craftsman</h2>
...
//            <div className={`glass-card rounded-[2.5rem] p-10 relative overflow-hidden transition-all duration-500 hover:shadow-2xl hover:shadow-purple-900/5 h-fit mt-2 scroll-fade-in-delay ${aboutVisible ? 'visible' : ''}`}>
//   <h3 className="text-2xl font-bold mb-8 relative z-10">
//     Skills & Expertise
//   </h3>
...
//   className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-32"
// >
//   <div className={`text-center mb-20 scroll-fade-in ${activityVisible ? 'visible' : ''}`}>
//     <h2 className="text-4xl font-bold text-slate-900 mb-4">
//       Code Activity
//     </h2>
//     <p className="text-slate-500 max-w-md mx-auto">
...
//   <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-stretch">
//     {/* GitHub */}
//     <div className={`glass-card p-10 rounded-[2.5rem] scroll-fade-in ${activityVisible ? 'visible' : ''}`}>
//       <div className="flex items-center justify-between mb-8">
//         <div className="flex items-center gap-3">
//           <div className="p-2 bg-purple-50 rounded-lg">
//             <GitCommit className="w-5 h-5 text-purple-600" />
...
//     {/* LeetCode */}
//     <div className={`glass-card p-10 rounded-[2.5rem] scroll-fade-in-delay ${activityVisible ? 'visible' : ''}`}>
//       <div className="flex items-center justify-between mb-8">
//         <div className="flex items-center gap-3">
//           <div className="p-2 bg-teal-50 rounded-lg">
//             <Terminal className="w-5 h-5 text-teal-600" />
...
//       {/* --- PROJECTS SECTION --- */}
// <section id="projects" ref={projectsRef} className="py-24 px-6 bg-slate-50/50 relative z-10 overflow-hidden">
//   <div className="max-w-7xl mx-auto flex flex-col items-center">
//     <div className={`text-center mb-12 scroll-fade-in ${projectsVisible ? 'visible' : ''}`}>
//       <div className="text-sm font-bold tracking-widest text-slate-500 uppercase mb-4">
//         Projects
//       </div>
//       <h2 className="text-4xl font-bold text-slate-900">Selected work</h2>
...
//     {/* Carousel */}
//     <div className={`relative w-full h-[400px] flex items-center justify-center scroll-fade-in-delay ${projectsVisible ? 'visible' : ''}`}>
//       {projects.map((project, index) => {
//         const styleClass = getCardStyle(index);
//         const isCenter = index === currentIndex;
...
//       {/* --- CONTACT SECTION (FULL SCREEN) --- */}
//       <section id="contact" ref={contactRef} className="min-h-screen py-24 px-6 relative z-10 max-w-7xl mx-auto flex flex-col justify-center">
//          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center flex-grow">
//             <div className={`space-y-8 scroll-fade-in ${contactVisible ? 'visible' : ''}`}>
//                <div className="text-sm font-bold tracking-widest text-slate-500 uppercase">Get in touch</div>
//                <h2 className="text-4xl md:text-5xl font-bold text-slate-900">Let's work together</h2>
//                <p className="text-lg text-slate-600 leading-relaxed max-w-md">I'm currently available for freelance work and collaborations.</p>
//                <div className="space-y-6 pt-4">
...
//                   </div>
//                   <div className="flex items-center gap-4 group cursor-none">
//                      <div className="w-12 h-12 rounded-full bg-slate-100 flex items-center justify-center group-hover:bg-black group-hover:text-white transition-colors duration-300"><MapPin className="w-5 h-5" /></div>
//                      <div><div className="text-sm font-medium text-slate-500">Location</div><div className="text-lg font-semibold text-slate-900">Bangalore, India</div>
//                      </div>
//                   </div>
//                </div>
//             </div>
//             <div className={`glass-card p-8 sm:p-10 rounded-[2.5rem] relative overflow-hidden group transition-all duration-500 hover:-translate-y-2 hover:shadow-purple-900/10 scroll-fade-in-delay ${contactVisible ? 'visible' : ''}`}>
//                <div className="absolute top-0 right-0 w-40 h-40 bg-yellow-100/50 rounded-full blur-[50px] pointer-events-none group-hover:bg-purple-100/50 transition-colors duration-500" />
//                <div className="relative z-10">
//                   <h3 className="text-2xl font-bold text-slate-900 mb-2">Ready to start a project?</h3>
//                   <p className="text-slate-500 mb-8 text-sm">Fill out the form below and I'll get back to you within 24 hours.</p>
...
const CustomCursor = () => {
  ...
  return (
    <>
      <div ref={cursorRef} className="fixed top-0 left-0 w-2 h-2 bg-black rounded-full pointer-events-none z-[99999]" />
      <div ref={ringRef} className="fixed top-0 left-0 w-8 h-8 border border-black/30 rounded-full pointer-events-none z-[99998] transition-all duration-100 ease-out" />
    </>
  );
};
...
useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-slate-50/30 to-purple-50/20 text-slate-900 font-sans selection:bg-purple-100 selection:text-purple-900 relative overflow-x-hidden cursor-none scroll-smooth">
      <CustomCursor />
      ...
      {/* --- NAVBAR --- */}
      <nav className={`fixed top-6 left-1/2 -translate-x-1/2 z-[9999] transition-opacity duration-300 ${expandedProject ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
  <div
    className={`
      flex items-center justify-between
      rounded-full
  ...
  >
    ...
    >
      ...
      {/* Mobile Menu */}
      {isMenuOpen && !expandedProject && (
        <div className="fixed inset-0 bg-white/95 backdrop-blur-xl z-[9998] pt-32 px-6 md:hidden">
          <div className="flex flex-col items-center gap-6">
            {['Home', 'About', 'Activity', 'Projects', 'Contact'].map((item) => (
              <a key={item} href={`#${item.toLowerCase()}`} className="text-2xl font-medium text-slate-900 cursor-none" onClick={() => setIsMenuOpen(false)}>{item}</a>
            ))}
      ...
      <section id="home" className="relative z-10 pt-48 lg:pt-60 px-6 overflow-hidden">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24 relative z-10">
          ...
          <div className="space-y-8 relative">
            <div className="relative z-10">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/60 backdrop-blur-xl border border-white/60 text-xs font-bold tracking-wide uppercase text-slate-700 reveal-1 shadow-sm">
                <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
                Full Stack Developer 
              </div>
              <h1 className="text-5xl lg:text-7xl font-bold tracking-tight text-slate-900 leading-[1.1] reveal-2 mt-6">
  ...
  from real-time features to production-ready infrastructure.
              ...
              <a
  href="#projects"
  className="bg-black/90 backdrop-blur-xl text-white px-8 py-4 rounded-full font-medium hover:bg-black transition-all flex items-center gap-2 group shadow-xl shadow-purple-900/10 cursor-none hover:scale-105 active:scale-95 duration-300 border border-white/10"
>
  View my work
  <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
</a>

<a href={resume} download="Jeffrey_Thomas_Resume.pdf">
  <button className="bg-white/70 backdrop-blur-xl text-slate-900 border border-white/50 px-8 py-4 rounded-full font-medium hover:bg-white/90 transition-all flex items-center gap-2 shadow-sm cursor-none hover:scale-105 active:scale-95 duration-300">
    Download Resume <Download className="w-4 h-4" />
  </button>
</a>
      ...
      {/* --- MARQUEE --- */}
      <div className="w-full border-y border-white/40 bg-white/40 backdrop-blur-xl py-6 overflow-hidden relative z-10 shadow-sm">
  <div className="whitespace-nowrap flex animate-scroll items-center">
    {[...marqueeItems, ...marqueeItems].map((item, i) => (
      <div
        key={i}
...
>
  ...
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-stretch">
    ...
    <div className={`glass-card p-10 rounded-[2.5rem] scroll-fade-in ${activityVisible ? 'visible' : ''}`}>
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-3">
          <div className="p-2 bg-purple-50/60 backdrop-blur-md border border-white/50 rounded-lg shadow-sm">
            <GitCommit className="w-5 h-5 text-purple-600" />
          </div>
          <span className="font-semibold text-slate-800">
            GitHub
    ...
    <div className={`glass-card p-10 rounded-[2.5rem] scroll-fade-in-delay ${activityVisible ? 'visible' : ''}`}>
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-3">
          <div className="p-2 bg-teal-50/60 backdrop-blur-md border border-white/50 rounded-lg shadow-sm">
            <Terminal className="w-5 h-5 text-teal-600" />
          </div>
          <span className="font-semibold text-slate-800">
            LeetCode
      ...
      {/* --- PROJECTS SECTION --- */}
<section id="projects" ref={projectsRef} className="py-24 px-6 bg-white/30 backdrop-blur-sm relative z-10 overflow-hidden">
  <div className="max-w-7xl mx-auto flex flex-col items-center">
    <div className={`text-center mb-12 scroll-fade-in ${projectsVisible ? 'visible' : ''}`}>
      <div className="text-sm font-bold tracking-widest text-slate-500 uppercase mb-4">
        Projects
      ...
      {projects.map((project, index) => {
        ...
        return (
          <div
            ...
            className={`absolute w-full bg-white/80 backdrop-blur-xl rounded-[2.5rem] overflow-hidden transition-all duration-700 border border-white/60 shadow-lg ${styleClass}`}
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 h-full">
              {/* IMAGE */}
              <div className="relative h-[200px] lg:h-full bg-slate-100 overflow-hidden">
              ...
              {/* CONTENT */}
              <div className="p-8 flex flex-col justify-center bg-white/70 backdrop-blur-xl">
                <div
                  className={`transition-opacity duration-300 ${
                    isCenter ? "opacity-100" : "opacity-0 lg:opacity-30"
                  }`}
                >
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {project.tags.map((tag, i) => (
                      <span
                        key={i}
                        className="px-3 py-1 bg-white/70 backdrop-blur-md border border-white/60 rounded-full text-xs font-bold text-slate-600 shadow-sm"
                      >
                        {tag}
                      </span>
                    ))}
  ...
  <button
    onClick={prevProject}
    className="p-4 rounded-full bg-white/70 backdrop-blur-xl border border-white/60 text-slate-600
               hover:bg-black hover:text-white hover:border-black
               transition-all shadow-md active:scale-95"
  >
    <ChevronLeft className="w-6 h-6" />
  ...
  {expandedProject && (
    <>
      {/* Backdrop - stronger opacity and blur */}
      <div
        className="fixed inset-0 z-[10000] bg-black/80 backdrop-blur-xl animate-fadeIn"
        onClick={() => setExpandedProject(null)}
        style={{ backdropFilter: 'blur(12px)' }}
      />
      
      {/* Modal */}
      <div className="fixed inset-0 z-[10001] flex items-center justify-center p-4 overflow-y-auto" onClick={() => setExpandedProject(null)}>
        <div
          className="relative bg-white w-full max-w-5xl rounded-[2.5rem] overflow-hidden shadow-2xl animate-scaleIn my-auto"
          onClick={(e) => e.stopPropagation()}
        >
          {/* Close */}
          <button
            onClick={() => setExpandedProject(null)}
            className="absolute top-4 right-4 z-10 p-2.5 rounded-full bg-white hover:bg-black hover:text-white transition cursor-none shadow-lg border border-slate-200"
          >
            <X className="w-5 h-5" />
          </button>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            {/* Image Side */}
            <div className="relative h-64 sm:h-80 lg:h-auto lg:min-h-[600px] bg-slate-100">
              <img
                src={expandedProject.image}
                alt={expandedProject.title}
                className="w-full h-full object-cover"
            ...
            {/* Content Side with internal scroll */}
            <div className="flex flex-col max-h-[70vh] lg:max-h-[600px]">
              <div className="p-8 lg:p-10 overflow-y-auto flex-1">
                <h3 className="text-3xl lg:text-4xl font-bold mb-4 text-slate-900 pr-10">
                  {expandedProject.title}
                </h3>

                <div className="text-slate-400 mb-6 flex items-center gap-2 text-sm">
                  <Calendar className="w-4 h-4" />
                  {expandedProject.date}
                </div>

                <p className="text-slate-700 text-base lg:text-lg leading-relaxed mb-8">
                  {expandedProject.description}
                </p>
                ...
                <div className="flex flex-wrap gap-2 mb-8">
                  {expandedProject.tags.map((tag, i) => (
                    <span
                      key={i}
                      className="px-3 py-1.5 bg-slate-100 rounded-full text-xs font-semibold text-slate-700"
                    >
                      {tag}
                    </span>
                  ))}
              ...
              {/* Live Site Button - Fixed at bottom */}
              {expandedProject.live && (
                <div className="p-8 lg:p-10 pt-0 bg-white border-t border-slate-100">
                  <a
                    href={expandedProject.live}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full px-6 py-3 bg-black text-white rounded-full font-bold flex items-center justify-center gap-2 hover:bg-slate-800 transition cursor-none hover:scale-105 active:scale-95"
                  >
                    <Globe className="w-4 h-4" /> Live Site
                  </a>
                </div>
      ...
      <section id="contact" ref={contactRef} className="min-h-screen py-24 px-6 relative z-10 max-w-7xl mx-auto flex flex-col justify-center">
         <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center flex-grow">
            <div className={`space-y-8 scroll-fade-in ${contactVisible ? 'visible' : ''}`}>
               ...
               <div className="space-y-6 pt-4">
                  <div className="flex items-center gap-4 group cursor-none">
                     <div className="w-12 h-12 rounded-full bg-white/60 backdrop-blur-md border border-white/50 flex items-center justify-center group-hover:bg-black group-hover:text-white transition-colors duration-300 shadow-sm"><Mail className="w-5 h-5" /></div>
                     <div><div className="text-sm font-medium text-slate-500">Email</div><a href="mailto:jeffreythomas10566x@gmail.com" className="text-lg font-semibold text-slate-900 cursor-none">jeffreythomas10566x@gmail.com</a>
                     </div>
                  </div>
                  <div className="flex items-center gap-4 group cursor-none">
                     <div className="w-12 h-12 rounded-full bg-white/60 backdrop-blur-md border border-white/50 flex items-center justify-center group-hover:bg-black group-hover:text-white transition-colors duration-300 shadow-sm"><MapPin className="w-5 h-5" /></div>
                     <div><div className="text-sm font-medium text-slate-500">Location</div><div className="text-lg font-semibold text-slate-900">Bangalore, India</div>
                     </div>
                  </div>
               </div>
            ...
            <div className={`glass-card p-8 sm:p-10 rounded-[2.5rem] relative overflow-hidden group transition-all duration-500 hover:-translate-y-2 hover:shadow-purple-900/10 scroll-fade-in-delay ${contactVisible ? 'visible' : ''}`}>
               ...
               <div className="relative z-10">
                  ...
                  <p className="text-slate-500 mb-8 text-sm">Fill out the form below and I'll get back to you within 24 hours.</p>
                  <form ref={form} onSubmit={sendEmail} className="space-y-4">
                     <div><input type="text" name="user_name" placeholder="Your Name" required className="w-full bg-white/50 backdrop-blur-md border border-white/60 rounded-xl px-4 py-3.5 cursor-none focus:border-black focus:ring-0 transition-colors shadow-sm" /></div>
                     <div><input type="email" name="user_email" placeholder="Your Email" required className="w-full bg-white/50 backdrop-blur-md border border-white/60 rounded-xl px-4 py-3.5 cursor-none focus:border-black focus:ring-0 transition-colors shadow-sm" /></div>
                     <div><textarea name="message" rows="4" placeholder="Tell me about your project..." required className="w-full bg-white/50 backdrop-blur-md border border-white/60 rounded-xl px-4 py-3.5 resize-none cursor-none focus:border-black focus:ring-0 transition-colors shadow-sm" /></div>
                     {errorMessage && <div className="p-3 bg-red-50 border border-red-200 rounded-lg flex items-center gap-2 text-red-600 text-xs font-medium"><AlertCircle className="w-4 h-4 flex-shrink-0" />{errorMessage}</div>}
                     <button type="submit" disabled={isSubmitting || submitStatus === 'success'} className={`w-full py-4 rounded-full font-bold text-white transition-all duration-300 flex items-center justify-center gap-2 cursor-none hover:scale-[1.02] active:scale-[0.98] ${submitStatus === 'success' ? 'bg-emerald-500' : 'bg-black hover:bg-slate-800'}`}>
                       {isSubmitting ? <><Loader2 className="w-5 h-5 animate-spin" /> Sending...</> : submitStatus === 'success' ? "Message Sent!" : <><Send className="w-4 h-4" /> Send Message</>}
                     </button>
         ...
         {/* Footer Section */}
         {/* Footer Section - Light Theme Adaptation */}
<div className="w-full border-t border-slate-200 mt-16 bg-white/50 backdrop-blur-sm">
   <div className="max-w-7xl mx-auto px-6 py-16">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
         
         {/* Brand Column */}
         <div className="space-y-6">
            <div className="text-2xl font-bold text-slate-900">jeffrey.dev</div>
            <p className="text-slate-600 text-sm leading-relaxed">
               Building full-stack systems, real-time features, and scalable infrastructure.
            </p>
            <div className="flex items-center gap-3">
               <a 
                  href="https://www.linkedin.com/in/jeffrey-thomas-49000826b/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="w-10 h-10 rounded-full bg-slate-50 border border-slate-200 flex items-center justify-center text-slate-600 hover:bg-black hover:text-white transition-all cursor-none"
               >
               ...
               <a 
                  href="https://github.com/jeffrey-thomass" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="w-10 h-10 rounded-full bg-slate-50 border border-slate-200 flex items-center justify-center text-slate-600 hover:bg-black hover:text-white transition-all cursor-none"
               >
            ...
            <div className="flex items-center gap-2 pt-2">
               ...
               <span className="text-xs text-slate-500">Available for freelance</span>
            </div>
         </div>

         {/* Navigation Column */}
         <div className="space-y-6">
            <h4 className="text-sm font-bold tracking-widest text-slate-400 uppercase">Navigation</h4>
            <nav className="flex flex-col gap-3">
               <a href="#home" className="text-slate-600 hover:text-black transition-colors cursor-none text-sm font-medium">Home</a>
               <a href="#about" className="text-slate-600 hover:text-black transition-colors cursor-none text-sm font-medium">About</a>
               <a href="#activity" className="text-slate-600 hover:text-black transition-colors cursor-none text-sm font-medium">Activity</a>
               <a href="#projects" className="text-slate-600 hover:text-black transition-colors cursor-none text-sm font-medium">Projects</a>
               <a href="#contact" className="text-slate-600 hover:text-black transition-colors cursor-none text-sm font-medium">Contact</a>
            </nav>
         </div>

         {/* Contact Column */}
         <div className="space-y-6">
            <h4 className="text-sm font-bold tracking-widest text-slate-400 uppercase">Let's talk</h4>
            <p className="text-slate-600 text-sm leading-relaxed">
               Have a project in mind? Let's create something amazing together.
            </p>
            <a 
               href="mailto:jeffreythomas10566x@gmail.com"
               className="text-sm text-slate-900 font-bold hover:text-purple-600 transition-colors cursor-none inline-flex items-center gap-1 group"
            >
               jeffreythomas10566x@gmail.com
               <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </a>
            <button 
               onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
               className="px-6 py-2.5 bg-slate-50 border border-slate-200 text-slate-900 rounded-full text-sm font-medium hover:bg-black hover:text-white transition-all cursor-none flex items-center gap-2 hover:scale-105 active:scale-95"
            >
               Back to top
      ...
      <div className="border-t border-slate-200 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
         <div className="text-sm text-slate-500">
            © 2026 Jeffrey Thomas. All rights reserved.
         </div>
         ...
         <div className="text-xs text-slate-400">
            Made with <span className="text-red-500">❤️</span> in Bangalore, India
         </div>
      </div>
   </div>
</div>
